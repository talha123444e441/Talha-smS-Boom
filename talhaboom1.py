...
|__  $$__/       | $$| $$                | $$__  $$                                  
   ...
   | $$ /$$__  $$| $$| $$  | $$ /$$__  $$| $$  \ $$| $$  | $$| $$  | $$| $$ | $$ | $$
   | $$|  $$$$$$$| $$| $$  | $$|  $$$$$$$| $$$$$$$/|  $$$$$$/|  $$$$$$/| $$ | $$ | $$
   |__/ \_______/|__/|__/  |__/ \_______/|_______/  \______/  \______/ |__/ |__/ |__/
...
def start(target, counter, delay, ch, cc):
    ...
    while success < (int(bombs)):
        ...
        try:
            ...
            if cc == "91":
                print('Sorry All APIs Have Expired Please Update SBomb')
        ...
        print("              This Bomber Was Created BY Mr Talha 💀👑              ")
        print("==================================================================")
        try:
...
if nm == 0:
    ...
    if nt <= 0 or nt >= 30:
        print('\tSBomb Shows Better Result in 10 to 25 Threads\n\t\tStill Continuing....')
